...
Code used and modified from the LEAKER framework for our research. Link: https://github.com/encryptogroup/LEAKER
...
def arr(token_result_pairs, ordering, a, b, n, e=0.01):
    """
